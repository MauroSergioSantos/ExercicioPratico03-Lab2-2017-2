...
namespace WebApp_ExercicioPratico03_Lab2_2017_2.Controllers
{
    public class ProfessorController : Controller
    {
        ...
        {
            var professors = db.Professors.Include(p => p.NivelEnsino);
        ...
        {
            ViewBag.NivelEnsinoId = new SelectList(db.NivelEnsinos, "NivelEnsinoId", "Descricao");
            return View();
        }
        ...
        public ActionResult Create([Bind(Include = "ProfessorId,ProfessorNome,TipoProfessor,NivelEnsinoId")] Professor professor)
        {
            ...
            ViewBag.NivelEnsinoId = new SelectList(db.NivelEnsinos, "NivelEnsinoId", "Descricao", professor.NivelEnsinoId);
            return View(professor);
        }
